...
data class PolicyState(
    ...
    /** "Tezkor blok" kartasi uchun — kim nechta ilovani yopgan, mening blokim holati. */
    val quick: QuickBlockSnapshot get() = QuickBlockSnapshot(entries = quickBlocks, myUserId = myUserId)
